...
func (repo *artistRepository) FindExistsArtistGenreByGenreId(ctx context.Context, artistId int, genreId int) (exists bool, err error) {
...
func (repo *artistRepository) StoreArtistGenre(ctx context.Context, artistId int, genreId int) (err error) {
...
func (repo *artistRepository) FindArtistGenres(ctx context.Context, artistId, pageSize, offset int) (genres []models.Genre, err error) {
...
func (repo *artistRepository) DeleteArtistGenre(ctx context.Context, artistId int, genreId int) (err error) {
